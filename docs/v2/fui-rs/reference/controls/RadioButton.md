...
Single radio option, optionally owned by a group.

## Constructor

- `radio_button(label)`, `RadioButton::new(label)`

## Key APIs

- `check`, `value`, `on_changed`, `template`, `sizing`, `colors`, inherited node/layout APIs.
